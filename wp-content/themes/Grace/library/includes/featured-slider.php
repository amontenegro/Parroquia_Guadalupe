              ...
              <div class="panel">
                <div class="slider-post">
                  <div class="slider-title">
                    <a title="<?php the_title(); ?>" href="<?php echo get_permalink(); ?>" class="slider_link"><?php the_title(); ?></a>
                  </div>
                  <?php if (get_post_meta($post->ID, "image", true)) { ?>
                  <a title="<?php the_title(); ?>" href="<?php echo get_permalink(); ?>"><img src="<?php echo get_post_meta($post->ID, "image", $single = true); ?>" alt="<?php the_title(); ?>" class="fl" /></a>
                  <?php } ?>
                  <?php the_excerpt(); ?>                 
                   <div id="action" >
