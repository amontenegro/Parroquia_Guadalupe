  ...
  <div id="content"  class="grid_8">
    ...
    <div id="post-<?php the_ID(); ?>" class="posts clearfix page">
      ...
      <div class="post_content">
       ...
       <div class="post_img clearfix"> <img src="<?php echo bloginfo('template_url'); ?>/thumb.php?src=<?php echo get_post_meta($post->ID, "image", $single = true); ?>&amp;w=540&amp;zc=1&amp;q=80<?php echo $thumb_url;?>" alt="<?php the_title(); ?>"    />   
         </div>
         <?php } ?>
